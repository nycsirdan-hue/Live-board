      ...
      >
        {sortedEntries.map((entry) => {
          ...
          return (
            <div
              key={entry.id}
              className="relative mb-2.5 w-fit max-w-[18rem] overflow-hidden rounded-2xl border border-white/15 bg-black/25 px-4 py-3 shadow-[0_12px_30px_rgba(0,0,0,0.28)] backdrop-blur-md"
              style={{
                breakInside: "avoid",
